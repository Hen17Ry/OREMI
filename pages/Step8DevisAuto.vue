    ...
    <div class="devis-container">
      <div class="devis-card">
        ...
        <div class="devis-card-body">
          ...
          <div class="cip-grid">
            ...
            <div class="cip-input-row">
              ...
              <input type="text" class="cip-input" placeholder="Nom" />
            </div>
            <!-- Prénom -->
            <div class="cip-input-row">
              <span class="material-icons cip-icon">badge</span>
              <input type="text" class="cip-input" placeholder="Prénom" />
            </div>
            <!-- Téléphone -->
            <div class="cip-input-row cip-phone-row">
              ...
              <input type="text" class="cip-input" placeholder="Numéros" />
            </div>
            <!-- Date de naissance -->
            <div class="cip-input-row">
              <span class="material-icons cip-icon">calendar_month</span>
              <input type="date" class="cip-input" placeholder="Date de naissance" />
            </div>
            <!-- Ville/Commune -->
            <div class="cip-input-row">
              <span class="material-icons cip-icon">location_city</span>
              <input type="text" class="cip-input" placeholder="Ville/Commune" />
            </div>
            <!-- Profession -->
            <div class="cip-input-row">
              <span class="material-icons cip-icon">work</span>
              <input type="text" class="cip-input" placeholder="Profession" />
            </div>
            <!-- Sexe -->
            <div class="cip-input-row">
              <span class="material-icons cip-icon">wc</span>
              <input type="text" class="cip-input" placeholder="Sexe" />
            </div>
            <!-- Email -->
        ...
        <div class="devis-actions">
          <NuxtLink to="/Step7DevisAuto" class="devis-btn devis-btn-outline">
