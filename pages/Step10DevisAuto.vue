    ...
    <div class="devis-container">
      <div class="devis-card">
        <div class="devis-card-header devis-card-header-progress">
          A quelle date souhaitez-vous que l’assurance prenne effet ?
          <div class="progress-bar"></div>
        </div>
        <div class="devis-card-body">
          <div class="cip-title">Informations supplémentaires</div>
          <div class="cip-grid">
            <div class="cip-input-row cip-input-row-full">
              <span class="material-icons cip-icon">badge</span>
              <input type="date" class="cip-input" placeholder="Date de début du contrat" />
            </div>
          </div>
        </div>
        <div class="devis-actions">
          <NuxtLink to="/Step9DevisAuto" class="devis-btn devis-btn-outline">
            <span class="material-icons">arrow_back</span> Retour
          </NuxtLink>
          <NuxtLink to="/Paiement" class="devis-btn devis-btn-primary">
            Continuer
          </NuxtLink>
        </div>
      </div>
